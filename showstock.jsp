...
ResultSet rs1=stmt.executeQuery("select * from bloodbank where licenseno='"+lic+"'");  
if(rs1.next()) { 
...
try
{
	...
	String q="update bloodstock set aposprice='"+aposp+"',aposstock='"+aposp+"',anegprice='"+anegp+"',anegstock='"+anegs+"'	,bposprice='"+bposp+"',bposstock='"+bposs+"',bnegprice='"+bnegp+"',bnegstock='"+bnegs+"',abposprice='"+abposp+"',abposstock='"+abposp+"',abnegprice='"+abnegp+"',abnegstock='"+abnegs+"',oposprice='"+oposp+"',oposstock='"+oposp+"',onegprice='"+onegp+"',onegposstock='"+onegs+"'";
			//Statement stmt=con.createStatement();
