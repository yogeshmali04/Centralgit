...
ResultSet rs=stmt.executeQuery("select * from pathologyappointment where mob='"+uname+"'");  
if(rs.next()) { 
	String stat=rs.getString(10);
	 ...
	 if(stat.equals("Pending"))
	 {
		 ...
		 String update="update pathologyappointment set status='Confirmed' where mob='"+uname+"'";
	 ...
	 {
		 String update="update pathologyappointment set status='Pending' where mob='"+uname+"'";
		 PreparedStatement ps=con.prepareStatement(update);
		 int done=ps.executeUpdate();
		 if(done==1)
		 {
