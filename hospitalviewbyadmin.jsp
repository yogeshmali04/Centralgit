...
<form action="hospitalviewbyadmin.jsp">
...
try
{
	...
	String q="select * from hospital where city='"+uname+"' or name='"+uname+"'or dean='"+uname+"'";
	...
	%>
	<table border=1 style="margin-left:11%">
		<tr><td>Name</td><td>Dean</td><td>License No</td><td>Establishment</td><td>Mobile</td><td>Email</td><td>Address</td></tr>
	...
	while(rs.next()){
		...
		String city=rs.getString(10);
		  ...
		  %>
		<tr><td><%=name %></td><td><%=owner %></td><td><%=address %></td><td><%=lic %></td><td></td><td><%=email %></td><td><%=city %></td><td><a href="doctordetails.jsp?name=<%=name%>">Click</a></td></tr>
...
try
{
	...
	%>
	<table border=1 style="margin-left:11%">
		<tr><td>Name</td><td>Dean</td><td>License No</td><td>Establishment</td><td>Email</td><td>Address</td><td>Action</td></tr>
	...
	while(rs.next()){
		...
		String city=rs.getString(10);
		  ...
		  %>
		<tr><td><%=name %></td><td><%=owner %></td><td><%=address %></td><td><%=lic %></td><td><%=email %></td><td><%=city %></td><td><a href="hdeletefromadmin.jsp?email=<%=email%>">X</a></td></tr>
