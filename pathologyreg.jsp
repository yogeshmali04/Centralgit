...
<form action="pathologyreg1.jsp" method="post" enctype="multipart/form-data">
<tr>
...
<tr>
<td>Pathology Name</td><td><input type="text" name="name" required></td>
</tr>
<tr>
...
<tr>
<td>Photo</td><td><input type="file" name="pphoto"></td>
</tr>
<tr>
