...
<form action="appointmenth.jsp" method="post">
<tr>
...
try
{
	...
	String q="insert into hospitalappointment(name,address,age,gender,problem,mob,email,hospital,city,status) values('"+name+"','"+address+"',"+age+",'"+gender+"','"+problem+"',"+mob+",'"+email+"','"+hospname+"','"+city+"','"+status+"')";
