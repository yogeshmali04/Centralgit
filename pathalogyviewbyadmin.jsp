...
<form action="pathalogyviewbyadmin.jsp">
		...
		
{
	...
	//	String ci=rs.getString(11);
		...
		%>
		<tr><td><%=name %></td><td><%=owner %></td><td><%=address %></td><td><%=lic %></td><td><%=mob %></td><td><%=city %></td><td><a href="pdeletefromadmin.jsp?mob=<%=mob%>">X</a></td></tr>
