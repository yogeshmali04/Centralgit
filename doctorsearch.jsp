		...
		
{
		...
		<br><a href="doctordetails.jsp?name=<%=name%>" style="color:white;background-color:#267de0;padding:10px 120px;margin-left:0s%;border-radius:10px;
		;" >View Details</a>
