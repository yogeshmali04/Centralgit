...
<form action="doctorviewbyadmin.jsp">
<h1>Doctor Search</h1>
...
try
{
	...
	String q="select * from doctor where city='"+uname+"' or name='"+uname+"'";
	...
	<table border=1 style="margin-left:10%">
		<tr><td>Name</td><td>Address</td><td>Doctor Type</td><td>Education</td><td>License No</td><td>Mobile</td><td>Email</td><td>Hospital</td><td>Hospital Address</td><td>Action</td></tr>
		...
		
{
		...
		%>
		<tr><td><%=name %></td><td><%=owner %></td><td><%=address %></td><td><%=lic %></td><td><%=mob %></td><td><%=city %></td><td><%=ci %></td><td><%=ci1 %></td><td><%=ci2 %></td><td><a href="ddeletefromadmin.jsp?email=<%=ci%>">X</a></td></tr>
