...
try
{
	...
	String q="select * from bloodbank where city='"+uname+"' or name='"+uname+"'or owner='"+uname+"'";
...
%>		  <div style="margin-left:30%;">
			...
			<span style="color:red;font-size:38px;font-style:italic;margin-top:-20px;font-size:30px"><%=name %></span ><br><span><%=address %>,<%=city %>
			</span><br>
			<br><a href="bloodbankdetails.jsp?lic=<%=lic%>" style="color:white;background-color:#267de0;padding:10px 120px;margin-left:0s%;border-radius:10px;
			;" >View Details</a>
