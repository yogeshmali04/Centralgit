...
<form action="instruments.jsp" method="post">
<tr>
...
<td>Work</td><td><input type="text" name="price" required></td>
</tr>
...
<td><input type="submit" value="submit" name="submit"></td><td><input type="reset" value="Clear"></td>
	...
	<h3 style="margin-left:80%;margin-top:-100px;">Available Instruments</h3>
...
ResultSet rs2=stmt1.executeQuery("select * from instruments where lab='"+hname+"'");  
while(rs2.next()) { 
...
try
{
	...
	String q="insert into instruments(instrument,work,lab) values('"+name+"','"+price+"','"+hname+"')";
	//Statement stmt=con.createStatement();
